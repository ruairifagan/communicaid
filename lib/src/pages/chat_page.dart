...
class _ChatPageState extends State<ChatPage> {
  ...
  Future<void> _sendImage(List<int> imageData) async {
    ...
    final result = await _uploadImageToServer(imageData);
  ...
  Future<Map<String, String>> _uploadImageToServer(List<int> imageData) async {
  ...
  Future<void> _sendMessage(Message message) async {
    ...
    Firestore.instance.runTransaction((transaction) async {
      ...
      await transaction.set(documentSnapshot.reference, message.toMap());
    });
          ...
          itemBuilder: (ctx, index) {
            return ClipRRect(
              ...
              borderRadius: BorderRadius.only(
                topRight:
                    index == 0 ? Radius.circular(20.0) : Radius.circular(0.0),
                topLeft: index == 2
          ...
          children: <Widget>[
            InkWell(
              ...
              child: Padding(
                ...
                child: Icon(
                  Icons.camera_alt,
                  color:
                      _isImageOptionClicked ? Color(0xff1c7aed) : Colors.grey,
                ),
              ),
            ),
            InkWell(
              child: Padding(
                ...
                child: Icon(
                  Icons.tag_faces,
                  color:
                      _isStickerOptionClicked ? Color(0xff1c7aed) : Colors.grey,
                ),
              ),
              onTap: () {
                _focusNode.unfocus();
            ...
            InkWell(
              child: Padding(
                ...
                child: Icon(
                  Icons.send,
                  color: _isTyping ? Color(0xff1c7aed) : Colors.grey[400],
                ),
              ),
              onTap: _isTyping
                  ? () {
