...
import 'package:communicaid/core/error/exceptions.dart';
import 'package:communicaid/features/login/data/datasources/login_local_data_source.dart';
import 'package:communicaid/injection_container.dart';
import 'package:communicaid/main.dart';
import 'package:communicaid/src/pages/chat_page.dart';
  ...
  Future<void> registerNotificationsForUser(String currentUserId) {
    ...
    firebaseMessaging.getToken().then((token) {
      ...
      Firestore.instance
          ...
          .updateData({'pushToken': token, 'createdAt': FieldValue.serverTimestamp(), 'platform': Platform.operatingSystem});
    }).catchError((err) {
